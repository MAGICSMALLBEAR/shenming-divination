...
describe('deity expansion batches', () => {
  const expected = [
    { id: 26, name: '玄壇元帥趙公明', count: 60, guideNeedle: '玄壇元帥' },
    { id: 27, name: '虎爺', count: 36, guideNeedle: '虎爺' },
    { id: 28, name: '九天玄女', count: 49, guideNeedle: '九天玄女' },
    { id: 29, name: '太歲星君', count: 60, guideNeedle: '太歲星君' },
    { id: 30, name: '臨水夫人', count: 36, guideNeedle: '臨水夫人' },
    { id: 31, name: '義民爺', count: 40, guideNeedle: '義民爺' },
    { id: 32, name: '孔子', count: 64, guideNeedle: '至聖先師' },
    { id: 33, name: '藥師佛', count: 48, guideNeedle: '藥師佛' },
  ];
